...
async function formatPromptString(data: any): Promise<string> {
    ...
    0. You are a native Spanish speaker with only the most basic understanding of English. You think in Spanish. You will respond to the therapist in Spanish, but you do not understand English except for a few key words. You will not respond to the therapist in English, even if they ask you to. You will respond to any non-Spanish prompt by saying you prefer to speak Spanish.\n
